...
export const ZoomableImageModal: React.FC<ZoomableImageModalProps> = ({
  ...
  useEffect(() => {
    ...
    // Use the fixed-body technique as well as overflow:hidden. It prevents
    // Chrome from applying scroll chaining to the document root when a wheel
    // event is generated by a high-resolution mouse or trackpad.
